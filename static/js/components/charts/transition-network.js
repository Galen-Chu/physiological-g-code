/**
 * Transition Network Component - Displays hexagram transition graph
 */
...
class TransitionNetwork {
    ...
    /**
     * Render transition network from API data
    ...
    render(data) {
        ...
        if (data.data && data.layout) {
            ...
            this.showError('Invalid data format for transition network');
        }
    }
